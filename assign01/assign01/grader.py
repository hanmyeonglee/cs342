...
grader.addHiddenPart('4a-1-hidden', lambda : testq4(700), 1, maxSeconds=maxSeconds, description='Check if score at least 700 on smallClassic.')
grader.addHiddenPart('4a-2-hidden', lambda : testq4(900), 1, maxSeconds=maxSeconds, description='Check if score at least 1000 on smallClassic.')
grader.addHiddenPart('4a-3-hidden', lambda : testq4(1100), 1, maxSeconds=maxSeconds, description='Check if score at least 1200 on smallClassic.')
grader.addHiddenPart('4a-4-hidden', lambda : testq4(1300), 1, maxSeconds=maxSeconds, description='Check if score at least 1400 on smallClassic.')
grader.addHiddenPart('4a-5-hidden', lambda : testq4(1500), 1, maxSeconds=maxSeconds, description='Check if score at least 1500 on smallClassic.')
