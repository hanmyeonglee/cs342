...
grader.addHiddenPart(
    "1a-1-hidden", test_correct("problem_1a", assertion, veceq), 4, maxSeconds=1
)
...
grader.addBasicPart("2a-0-basic", test2a0, 2, maxSeconds=1, description="basic test")
...
grader.addBasicPart(
    "2c-0-basic", test2c0, 2, maxSeconds=1, description="test basic bigram features"
)
